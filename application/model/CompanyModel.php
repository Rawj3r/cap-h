<?php
    ...
    */
    class CompanyModel{
        ...
        */
        public static function createCompany($name, $type, $size, $address, $city, $province){
            ...
            $sql = "INSERT INTO company_information (user_id, company_name, type, size, address, city, province) VALUES (:user_id, :company_name, :type, :size, :address, :city, :province)";
            $query = $database->prepare($sql);
            $query->execute(array(':user_id' => Session::get('user_id'), ':company_name' => $name, ':type' => $type, ':size' => $size, ':address' => $address, ':city' => $city, ':province' => $province));
