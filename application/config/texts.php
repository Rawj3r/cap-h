...
return array(
    ...
    "FEEDBACK_FIELD_EMPTY" => "Field was empty.",
    ...
    "FEEDBACK_TAX_ALREADY_TAKEN" => "Sorry, that TAX number is associated with an existing user.",
    "FEEDBACK_ID_ALREADY_TAKEN" => "Sorry, that ID/Passport number is associated with an existing user.",
    ...
    "FEEDBACK_NEW_USER_VERIFICATION_MAIL_SENDING_FAILED" => "Sorry, verification mail not send. This account has NOT been created.",
    ...
    "FEEDBACK_LEAVE_APPROVAL_SUCCESSFUL" => "Leave approved successfully.",
);
