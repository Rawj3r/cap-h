                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small button-group float-right">
                                            <a class="button alert hollow" href="<?= Config::get('URL') . 'dashboard/decline/' . $value->request_id; ?>">Decline</a></td>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small button-group float-right">
                                            <a class="button success hollow" href="<?= Config::get('URL') . 'dashboard/approve/' . $value->id; ?>">Recall</a></td>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
