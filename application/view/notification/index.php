            ...
            <div class="large-12 cell">
                <ul class="tabs" data-tabs id="example-tabs" style="border-bottom: 0 !important;">
                    <li class="tabs-title is-active">
                        <a aria-selected="true" href="<?php echo Config::get('URL'); ?>notification/index">Pending</a>
                    </li>
                    <li class="tabs-title">
                ...
                <?php if (Session::get("user_account_type") == 7) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small button-group float-right">
                                            <a class="button success hollow" href="<?= Config::get('URL') . 'dashboard/approve/' . $value->request_id; ?>">Approve</a>&nbsp;<a class="button alert hollow" href="<?= Config::get('URL') . 'dashboard/decline/' . $value->request_id; ?>">Decline</a></td>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="large-12 text-center cell">
                            ...
                            <br><br>
                            <h6 class="subheader">No pending leaves</h6>
                        </div>
                    <?php } ?>
                <?php } ?>
