...
<div class="main-container">
    <div class="grid-container">
        <div class="grid-x grid-padding-x">
            ...
            <br><br>
                <form role="form" class="form-horizontal text-left" action="request" method="post" name="paygate_initiate_form">
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="RETURN_URL" id="RETURN_URL" class="form-control" value="<?php echo $fullPath['protocol'] . $fullPath['host'] . '/' . $root . '/pay/result'; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
