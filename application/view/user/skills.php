        ...
        <div class="grid-x grid-padding-x">
            <ul class="tabs cell" data-tabs id="example-tabs">
                    ...
                    <li style="display:none;" class="tabs-title">
                        <a aria-selected="true" href="<?php echo Config::get('URL'); ?>user/skills">Skills information</a>
                    </li>
                    <li class="tabs-title">
                ...
                <?php if ($this->user) { ?>
                    <div class="grid-x grid-padding-x background">
                        ...
                        <div class="large-2 cell">
                            <br><br>
                            <a href="<?php echo Config::get('URL'); ?>user/edituseremail" class="button hollow tiny float-right">Settings</a>
                        </div>
                    </div>
                    <div class="grid-x grid-padding-x">
                        <div class="large-12 cell">
