        ...
        */
        public function index(){
            ...
            $this->View->render('user/index', array(
                ...
                'user' => UserModel::getProfileOfUser()
            ));
        }

        /**
        *   Show user's PRIVATE payroll information
        */
        public function payroll(){

            $this->View->render('user/payroll');
        }

        /**
        *   Show user's PRIVATE employment information
        */
        public function employment(){

            $this->View->render('user/employment', array(
                'user_name' => Session::get('user_name'),
                'user_email' => Session::get('user_email'),
                'user_gravatar_image_url' => Session::get('user_gravatar_image_url'),
                'user_avatar_file' => Session::get('user_avatar_file'),
        ...
        /**
        *   Show user's PRIVATE leave information
        */
        public function leaves(){

            $this->View->render('user/leaves', array('leave_information' => LeaveModel::userLeaveInformation()));
        }
